...
part of 'tarefa__mobx_model.dart';
...
mixin _$TarefaStore on _TarefaStore, Store {
  late final _$descricaoAtom = Atom(
    name: '_TarefaStore.descricao',
    context: context,
  );
  ...
  late final _$concluidoAtom = Atom(
    name: '_TarefaStore.concluido',
    context: context,
  );
  ...
  late final _$_TarefaStoreActionController = ActionController(
    name: '_TarefaStore',
    context: context,
  );
